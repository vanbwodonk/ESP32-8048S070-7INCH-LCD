...
bool bitmap_to_framebuffer(uint16_t *buffer, uint16_t *from_bitmap, int16_t bitmap_w, int16_t bitmap_h, int16_t x,
                           int16_t y) {
...
void loadImage(int16_t targetIndex, uint16_t *targetFb) {
  ...
  Serial.print("Could not load index ");
  Serial.println(targetIndex);
  initSD();
}
